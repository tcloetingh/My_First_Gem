...
require "cloetingh_view_tool/version"

Gem::Specification.new do |spec|
  spec.name          = "cloetingh_view_tool"
  spec.version       = CloetinghViewTool::VERSION
  spec.authors       = ["Tyler Cloetingh"]
  spec.email         = ["tcloetingh@gmail.com"]
